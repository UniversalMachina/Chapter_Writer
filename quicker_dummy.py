...
def event_summary(brief_summary):
    # The modified prompt
...
# Call the function
event_names,response= event_summary(brief_summary)
...
def generate_passages(event_names, extract_integer, generate_passage):
    ...
    for i, event in enumerate(event_names):
        prompt_text = (f"How many passages should be used here for this event {event}\n"
                       ...
                       f"\nReturn an integer, here is an example:"
                       f"1")
